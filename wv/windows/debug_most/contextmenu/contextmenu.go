...
func Contextmenu(form lcl.IForm, browser wv.IWVBrowser) {
	...
	menuExitMemory.LoadFromBytes(menuExit)
	menuExitStreamAdapter := lcl.NewStreamAdapter(menuExitMemory, types.SoOwned)
	browser.SetOnContextMenuRequested(func(sender wv.IObject, webView wv.ICoreWebView2, args wv.ICoreWebView2ContextMenuRequestedEventArgs) {
	...
	// 代理事件, 自定义菜单项选择事件回调
	browser.SetOnCustomItemSelected(func(sender wv.IObject, menuItem wv.ICoreWebView2ContextMenuItem) {
