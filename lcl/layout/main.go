...
// alignRect 保存对齐的矩形范围
// alignInfo 对齐信息
func onCustomAlignPosiion(sender lcl.IWinControl, control lcl.IControl, newLeft *int32, newTop *int32, newWidth *int32, newHeight *int32, alignRect *types.TRect, alignInfo lcl.TAlignInfo) {
